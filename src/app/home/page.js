              ...
              <div className="w-full h-auto flex flex-col justify-start gap-[30px]">
                ...
                <div className="w-full h-auto flex justify-center lg:justify-start">
                  <ul className="flex items-center gap-5">
                    <li
                      className={`text-xs sm:text-base md:text-2xl font-medium cursor-pointer ${selectedType === "kehilangan"
                    ...
                    <li
                      className={`text-xs sm:text-base md:text-2xl font-medium cursor-pointer ${selectedType === "kerusakan"
                          ? "underline underline-offset-[5px] sm:underline-offset-[10px] text-[#00408A]"
                          : "text-[#8F8F8F]"
                        }`}
